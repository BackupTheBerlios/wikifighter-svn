...
{	
	...
	public class Site
	{
		...
		public readonly string site = "http://de.wikipedia.org";
		...
		public string disambigStr = "{{Begriffsklärung}}";
    	...
    	{
    		string[] wikiNSNames = { "Media", "Spezial", "", "Diskussion", "Benutzer", "Benutzer Diskussion", name,
    			name + " Diskussion", "Bild", "Bild Diskussion", "MediaWiki", "MediaWiki talk", "Vorlage",
    			"Vorlage Diskussion", "Hilfe", "Hilfe Diskussion", "Kategorie", "Kategorie Diskussion" };
	    ...
	    public void Save(string newText, string comment, bool isMinorEdit)
	    {
            ...
            do{
            	...
            	try{
            		...
            		failed = true;
            		v++;
            		Console.WriteLine("Versuch Nummer "+v+": ["+ e.Message + "] - will retry in 2s");
	...
	public class User
	{
		...
		public string name;
		/// <summary>Contributions of the user</summary>
		public PageList contribs=null;
	...
	public class History
	{
		...
		public History(ArrayList history){
			this.history = history;
		}
		
		public HistoryEntry getFirst()
		{
		//IEnumerator i = history.GetEnumerator(history.Count-1,1);
		//i.MoveNext();
		
		//return (HistoryEntry)i.Current;
		return (HistoryEntry)history[history.Count-1];
		}
		
		public HistoryEntry getLast()
		{
		/*IEnumerator i = history.GetEnumerator();
		i.MoveNext();
		return (HistoryEntry)i.Current;*/
		return (HistoryEntry)history[0];
		}
